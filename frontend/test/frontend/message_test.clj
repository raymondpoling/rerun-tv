...
(deftest test-messages
  (let [admin-cookie (make-cookie "admin")
    ...
    (testing-with-log-markers "can get page with auth"
  ...
  (testing-with-log-markers "cannot get page with user"
  ...
  (testing-with-log-markers "cannot get page with media"
    (let [response (app (-> (mock/request :get "/message.html")
                            media-cookie))]
      (is (= (:status response) 302))
      (is (= (get (:headers response) "Location")
  ...
  (testing-with-log-markers "can post as auth"
  ...
  (testing-with-log-markers "cannot post as media"
  ...
  (testing-with-log-markers "cannot post as user"
    (let [response (app (-> (mock/request :post "/message.html")
                            (mock/body {"message" "doesn't matter"
                                        "title" "who cares"})
                            media-cookie))]
